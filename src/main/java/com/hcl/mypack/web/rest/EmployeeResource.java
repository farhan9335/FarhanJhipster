...
/**
 * REST controller for managing {@link com.hcl.mypack.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(
                existingEmployee -> {
                    ...
                    if (employee.getEmployeeSpecialization() != null) {
                        existingEmployee.setEmployeeSpecialization(employee.getEmployeeSpecialization());
                    }
