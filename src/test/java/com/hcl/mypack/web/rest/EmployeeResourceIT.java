...
import com.hcl.mypack.domain.Employee;
import com.hcl.mypack.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    private static final String DEFAULT_EMPLOYEE_SPECIALIZATION = "AAAAAAAAAA";
    private static final String UPDATED_EMPLOYEE_SPECIALIZATION = "BBBBBBBBBB";
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .employeeSpecialization(DEFAULT_EMPLOYEE_SPECIALIZATION);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .employeeSpecialization(UPDATED_EMPLOYEE_SPECIALIZATION);
        return employee;
    }
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getEmployeeSpecialization()).isEqualTo(DEFAULT_EMPLOYEE_SPECIALIZATION);
    }
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].employeeSpecialization").value(hasItem(DEFAULT_EMPLOYEE_SPECIALIZATION)));
    }
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.employeeSpecialization").value(DEFAULT_EMPLOYEE_SPECIALIZATION));
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        assertThat(testEmployee.getEmployeeSpecialization()).isEqualTo(UPDATED_EMPLOYEE_SPECIALIZATION);
    }
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.employeeName(UPDATED_EMPLOYEE_NAME).employeeSpecialization(UPDATED_EMPLOYEE_SPECIALIZATION);
