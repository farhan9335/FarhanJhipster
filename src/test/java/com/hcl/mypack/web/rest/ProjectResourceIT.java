...
import com.hcl.mypack.repository.ProjectRepository;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().projectId(DEFAULT_PROJECT_ID).projectName(DEFAULT_PROJECT_NAME);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().projectId(UPDATED_PROJECT_ID).projectName(UPDATED_PROJECT_NAME);
        return project;
    }
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.projectId(UPDATED_PROJECT_ID).projectName(UPDATED_PROJECT_NAME);
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.projectId(UPDATED_PROJECT_ID);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.projectId(UPDATED_PROJECT_ID).projectName(UPDATED_PROJECT_NAME);
